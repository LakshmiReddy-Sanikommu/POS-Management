-- Gas Station Application - MySQL Database Setup Script
-- Run this script as MySQL root user to create the database and user

-- Create database
DROP DATABASE IF EXISTS gasstation;
CREATE DATABASE gasstation CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Create user and grant privileges
DROP USER IF EXISTS 'gasstation_user'@'localhost';
CREATE USER 'gasstation_user'@'localhost' IDENTIFIED BY 'gasstation_password';
GRANT ALL PRIVILEGES ON gasstation.* TO 'gasstation_user'@'localhost';
FLUSH PRIVILEGES;

-- Use the gasstation database
USE gasstation;
